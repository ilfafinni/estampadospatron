...
export const PRODUCTS: Product[] = [
  ...
  {id:10,c:'polerones',n:'Polerón Simple Clásico',ref:'ROLY-6950',e:'🧥',img:'https://res.cloudinary.com/dguwdbts9/image/upload/v1783789849/patronestampados/productos/producto-10.jpg',desc:'El básico imprescindible. Cuello redondo, tela gruesa. Estampado frontal y espalda.',v:{t:['XS','S','M','L','XL','XXL'],col:[{n:'Negro',h:'#111'},{n:'Gris',h:'#888'},{n:'Blanco',h:'#f0f0f0'},{n:'Azul',h:'#1a5276'}]},precio:'$15.000',},
